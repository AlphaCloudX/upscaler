...
from tensorflow.keras.layers import Conv2D, Conv3D, DepthwiseConv2D, Conv2DTranspose, Conv3DTranspose, ReLU, BatchNormalization, add, Softmax, AveragePooling2D, \
...
def model1(upscaleFactor):
    ...
    # Change 1 to 3 to represent amount of channels
